...
export default function m() {
  ...
  const spans = new Array(4)
    .fill(null)
    .map((_, i) => <span className={`corner${i + 1}`} key={`span${i}`}></span>);
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      card.classList.contains("hover") && card.classList.remove("hover");
    }, 3000);
  }, [isLoad]);
  ...
  }, [isLoad, windowHeight, windowWidth]);
  ...
  return (
    ...
    >
      <div className="profile-picture-container">
        <div className="profile-picture" ref={setRef("profilePicture")}>
          <div
            ...
            onClick={(e) => {
              ...
              setTimeout(() => target.classList.remove("hover"), 3000);
            }}
          >
